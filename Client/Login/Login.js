...
function DrawLoginScreen() {
    ...
    API.drawText("Login", Math.round(posX + (Width / 2)), Math.round(posY + 20), 2, 255, 255, 255, 255, 1, 1, false, false, 500);
    API.drawText("Password", Math.round(posX + 50), Math.round(PasswordY), 0.7, 255, 255, 255, 255, 4, 0, false, false, 500);
    if (cursorIndex == 0) {
    ...
    if (cursorIndex == 1) {
        ...
        API.drawText("Login", Math.round(posX + (Width / 2)), Math.round(PasswordY + 135), 0.7, 50, 50, 50, 255, 4, 1, false, false, 500);
    }
    else {
        API.drawRectangle(posX + 50, PasswordY + 130, Width - 100, 65, defaultButtonBg.X, defaultButtonBg.Y, defaultButtonBg.Z, 240);
        API.drawText("Login", Math.round(posX + (Width / 2)), Math.round(PasswordY + 135), 0.7, 255, 255, 255, 255, 4, 1, false, false, 500);
    }
}
